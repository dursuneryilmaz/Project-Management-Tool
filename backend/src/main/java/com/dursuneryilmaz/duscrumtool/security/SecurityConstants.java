...
public class SecurityConstants {
    ...
    // times
    public static final long AUTH_TOKEN_EXPIRATION_TIME = 864_000_000; // 10 days
    public static final long PASSWORD_RESET_TOKEN_EXPIRATION_TIME = 3_600_000; // 1hour
    public static final long EMAIL_VERIFICATION_TOKEN_EXPIRATION_TIME = 3_600_000; // 1hour

    // token properties
    public static final String HEADER_STRING = "Authorization";
    public static final String TOKEN_PREFIX = "Bearer ";
    public static final String AUTH_TOKEN_SECRET = "authTokenSecret";
    public static final String EMAIL_VERIFICATION_TOKEN_SECRET = "emailVerificationTokenSecret";
    public static final String PASSWORD_RESET_TOKEN_SECRET = "passwordResetTokenSecret";
